            ...
            <form id="form1" action="" method="post">
                <div class="loginInfo">
                    ...
                    <ul>
                        ...
                        <li class="row2"><input class="input" id="verify_code" name="verify_code" type="text" style="width:100px;" /> <img src="<?php echo ($site["WEB_ROOT"]); ?>index.php/Public/verify_code"  title="看不清？单击此处刷新" onclick="this.src+='?rand='+Math.random();"  style="cursor: pointer; vertical-align: middle;"/></li>
                    </ul>
                </div>
